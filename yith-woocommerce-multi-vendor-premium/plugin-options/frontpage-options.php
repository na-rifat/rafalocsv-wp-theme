...
return array(
    ...
    'frontpage' => array(
        ...
        'frontpage_vendors_registration_privacy_policy' => array(
	        'title' => __('Privacy Policy', 'yith-woocommerce-product-vendors'),
	        'type' => 'checkbox',
	        'desc' => __('Mark this field required', 'yith-woocommerce-product-vendors'),
        ...
        'frontpage_terms_and_conditions_title' => array(
            'title' => __("Terms and conditions & Privacy Policy page", 'yith-woocommerce-product-vendors'),
            'type' => 'title',
        ...
        'frontpage_privacy_page' => array(
	        'title' => __('"Privacy Policy" page', 'yith-woocommerce-product-vendors'),
	        'id' => 'yith_wpv_privacy_page',
	        'type' => 'single_select_page',
	        'default' => 0,
	        'class' => 'wc-enhanced-select-nostd',
	        'css' => 'min-width:300px;',
	        'desc' => __('This sets the page for vendors\' Privacy Policy.', 'yith-woocommerce-product-vendors'),
        ),
        'frontpage_privacy_revision enable' => array(
	        'title' => __('Manage Revisions', 'yith-woocommerce-product-vendors'),
	        'id' => 'yith_wpv_manage_terms_and_privacy_revision',
	        'type' => 'checkbox',
	        'default' => 'no',
	        'desc' => __('If enabled, on every update of the Terms and conditions or Privacy policy, the vendor will have to read and accept again','yith-woocommerce-product-vendors'),
        ),
        'frontpage_privacy_revision_actions' => array(
	        'title' => __('If vendors don\'t accept the new terms', 'yith-woocommerce-product-vendors'),
	        'type' => 'select',
			'class' => 'wc-enhanced-select',
	        'options' => array(
		        'no_action' => __('They can continue to sell as before', 'yith-woocommerce-product-vendors'),
		        'disable_now' =>__('Disable the vendor\'s selling features as soon as the Privacy policy or Terms and conditions are updated', 'yith-woocommerce-product-vendor'),
		        'disable_after' => __('Disable the vendor\'s selling features after x day since the last update of the Privacy policy or Terms and conditions', 'yith-woocommerce-product-vendor')
	        ),
	        'id' => 'yith_wpv_manage_terms_and_privacy_revision_actions',
	        'default' => 'no_action'
        ),
        'frontpage_privacy_revision_disable_after' => array(
	        'title' => __('Days', 'yith-woocommerce-product-vendors'),
	        'type' => 'number',
	        'min' => 0,
	        'step' => 1,
