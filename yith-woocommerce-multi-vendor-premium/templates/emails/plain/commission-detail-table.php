...
echo ! empty( $vendor->paypal_email ) ? $vendor->paypal_email : '-';
echo " \n\n";
...
echo ! empty( $item['name'] ) ? $item['name'] : esc_html_x( 'Shipping fee', '[admin]: commission type', 'yith-woocommerce-product-vendors' );
echo " \n\n";
