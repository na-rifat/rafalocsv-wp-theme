	...
	if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
		...
		<tr class="<?php echo esc_attr( apply_filters( 'woocoomerce_order_item_class', 'order_item', $item, $order ) ); ?>">
			<td style="text-align:left; vertical-align:middle; border: 1px solid #eee; word-wrap:break-word;"><?php
				...
				if ( $show_image && $_product instanceof WC_Product ) {
            ...
            ?>
			<td style="text-align:left; vertical-align:middle; border: 1px solid #eee;"><?php echo wc_price( $total, array( 'currency', $order->get_currency() ) ); ?></td>
		...
		<?php
		if( $commission ){
			$total_commissions_amount += $commission->amount;
		}
	}
...
<?php endforeach; ?>
<tr>
	<td colspan="<?php echo $tax_credited_to_vendor ? 5 : 4; ?>" style="font-weight: bold; text-align:left; vertical-align:middle; border: 1px solid #eee;"><strong><?php esc_html_e( 'Total', 'yith-woocommerce-product-vendors' ); ?></strong></td>
	<td style="text-align:left; vertical-align:middle; border: 1px solid #eee;"><?php echo wc_price( $total_commissions_amount, array( 'currency', $order->get_currency() ) ); ?></td>
</tr>
