...
?>
		...
		<tr>
			...
			<td style="text-align:left; vertical-align:middle; border: 1px solid #eee; word-wrap:break-word;"><?php echo ! empty( $vendor->paypal_email ) ? $vendor->paypal_email : '-' ?></td>
		</tr>
		...
		<tr>
			...
			<td style="text-align:left; vertical-align:middle; border: 1px solid #eee; word-wrap:break-word;"><?php echo ! empty( $item['name'] ) ? $item['name'] : esc_html_x( 'Shipping fee', '[admin]: commission type', 'yith-woocommerce-product-vendors' ); ?></td>
		</tr>
