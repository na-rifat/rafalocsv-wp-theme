(function ($) {
  ...
  $('#yith_wpv_enable_product_amount').yith_wpv_option_deps('#yith_wpv_vendors_product_limit', 'checkbox', false, false);
  ...
  vendor_order.yith_wpv_option_deps('#yith_wpv_vendors_option_order_refund_synchronization', 'checkbox', false, false);
  vendor_order.yith_wpv_option_deps('#yith_wpv_vendors_option_order_hide_customer', 'checkbox', false, false);
  vendor_order.yith_wpv_option_deps('#yith_wpv_vendors_option_order_hide_payment', 'checkbox', false, false);
  vendor_order.yith_wpv_option_deps('#yith_wpv_vendors_option_order_prevent_resend_email', 'checkbox', false, false);
  vendor_order.yith_wpv_option_deps('#yith_wpv_vendors_option_order_prevent_edit_custom_fields', 'checkbox', false, false);
  vendor_order.yith_wpv_option_deps('#yith_wpv_vendors_option_order_hide_shipping_billing', 'checkbox', false, false);
  $('#yith_vendors_show_gravatar_image').yith_wpv_option_deps('#yith_vendors_gravatar_image_size', 'select', 'disabled', false);
  $('#yith_wpv_vendors_option_editor_management').yith_wpv_option_deps('#yith_wpv_vendors_option_editor_media', 'checkbox', false, false);
  ...
  $('#yith_wpv_show_vendor_tab_in_single').yith_wpv_option_deps('#yith_wpv_vendor_tab_text_text', 'checkbox', false, false);
  $('#yith_wcmv_enable_paypal-masspay_gateway').yith_wpv_option_deps('all', 'checkbox', false, false);
  $('#yith_vendor_remove_vendor_profile_data').yith_wpv_option_deps('#yith_vendor_delete_vendor_media_profile_data', 'checkbox', false, false);
  $('#yith_wpv_vendors_registration_show_paypal_email').yith_wpv_option_deps('#yith_wpv_vendors_registration_required_paypal_email', 'checkbox', false, false);
  $('#yith_vendors_skin_header').yith_wpv_option_deps('#yith_vendors_skin_hmtl_header_image_format', 'select', 'double-box', true);
  $('#yith_wpv_manage_terms_and_privacy_revision').yith_wpv_option_deps('#yith_wpv_manage_terms_and_privacy_revision_actions', 'checkbox', false, false);
  $('#yith_wpv_manage_terms_and_privacy_revision').yith_wpv_option_deps('#yith_wpv_manage_terms_and_privacy_revision_disable_after', 'checkbox', false, false);

  $(document).on('change', '#yith_wpv_manage_terms_and_privacy_revision_actions', function (e) {

    var value = $(this).val(),
      field_to_check = $('#yith_wpv_manage_terms_and_privacy_revision_disable_after').parents('tr');

    if ('disable_after' === value) {
      field_to_check.css('opacity', '1');
      field_to_check.css('pointer-events', 'auto');
    } else {
      field_to_check.css('opacity', '0.3');
      field_to_check.css('pointer-events', 'none');
