...
if ( ! function_exists( 'yith_wcmv_aelia_get_order_exchange_rate' ) ) {
	function yith_wcmv_aelia_get_order_exchange_rate( WC_Order $order ) {
		// Get the exchange rate directly. This meta is going to be available in
		// an upcoming version of the Currency Switcher
