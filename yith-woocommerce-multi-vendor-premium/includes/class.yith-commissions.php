...
if ( ! class_exists( 'YITH_Commissions' ) ) {
	...
	class YITH_Commissions {
		...
		protected function _admin_init() {
			...
			add_filter( 'set_screen_option_edit_commissions_per_page', array( $this, 'set_screen_option' ), 10, 3 );
		...
		public function register_commissions_status( $order_id, $status ){
            ...
            if ( $processed == 'yes' ) {
                ...
                foreach ( $commission_ids as $commission_id ) {
	                ...
	                if( 'woocommerce_order_status_changed' == current_action() &&  in_array( $commission->get_status(), array( 'paid', 'processing' ) ) ){
						$skip_update = true;
	                }
