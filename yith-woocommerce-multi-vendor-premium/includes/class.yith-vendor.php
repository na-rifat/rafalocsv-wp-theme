...
if ( ! class_exists ( 'YITH_Vendor' ) ) {
     ...
     * @property    string     $data_privacy_policy
     * @property    string     $data_terms_and_condition
     *
     */
    class YITH_Vendor {
        ...
        public function get_registration_date ( $context = '', $format = '', $gmt = false ) {
            ...
            return self::get_date( $registration_date, $context, $format );
        }
	    ...
	    public function has_privacy_policy_accepted(){
	    	...
	    	$privacy_date_timestamp = strtotime( $this->data_privacy_policy );
	    ...
	    public function has_terms_and_conditions_accepted(){
	    	...
	    	$terms_date_timestamp = strtotime( $this->data_terms_and_condition );
