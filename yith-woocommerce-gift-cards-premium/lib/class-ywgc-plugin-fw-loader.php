...
if ( ! class_exists( 'YWGC_Plugin_FW_Loader' ) ) {
    ...
    class YWGC_Plugin_FW_Loader {
        ...
        public function __construct() {
	        ...
	        add_action( 'woocommerce_admin_field_export-csv-button', array( $this, 'show_export_csv_field' ) );

	        add_action( 'woocommerce_admin_field_import-csv-button', array( $this, 'show_import_csv_field' ) );

	        add_action( 'woocommerce_admin_field_date-from-to', array( $this, 'show_date_from_to_field' ) );
	    ...
	    public function show_export_csv_field( $option ) {

		    $option['option'] = $option;

		    wc_get_template( '/admin/export-csv-button.php', $option, '', YITH_YWGC_TEMPLATES_DIR );
	    }
	    ...
	    public function show_import_csv_field( $option ) {

		    $option['option'] = $option;

		    wc_get_template( '/admin/import-csv-button.php', $option, '', YITH_YWGC_TEMPLATES_DIR );
	    }
	    ...
	    public function show_date_from_to_field( $option ) {

		    $option['option'] = $option;

		    wc_get_template( '/admin/date-from-to.php', $option, '', YITH_YWGC_TEMPLATES_DIR );
	    }
        ...
        public function register_panel() {
            ...
            $admin_tabs['export_import'] = esc_html__( 'Export/Import', 'yith-woocommerce-gift-cards' );
