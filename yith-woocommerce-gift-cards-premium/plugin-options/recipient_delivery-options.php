...
//        ),
        ...
        'ywgc_attach_pdf_to_gift_card_code_email'        => array(
            ...
            'default' => 'no',
            'desc'    => esc_html__( 'If enabled, a PDF with the gift card will be attached to the gift card email.', 'yith-woocommerce-gift-cards' ),
        ),
        ...
        'ywgc_delivery_notify_customer_checkbox'      => array(
	        'name'    => esc_html__( 'Show delivery notification checkbox', 'yith-woocommerce-gift-cards' ),
	        'type'    => 'yith-field',
	        'yith-type' => 'onoff',
	        'id'      => 'ywgc_delivery_notify_customer_checkbox',
	        'desc'    => esc_html__( 'If enabled, the sender can select whether to receive the delivery gift card notification or not. If disabled, the sender will receive the delivery notification automatically.', 'yith-woocommerce-gift-cards' ),
	        'default' => 'no',
	        'deps'      => array(
		        'id'    => 'ywgc_delivery_notify_customer',
		        'value' => 'yes',
