...
$cart_checkout_options = array(
	...
	'cart_checkout' => array(
        ...
        'ywgc_apply_coupon_title_text_button'    => array(
	        'name'    => esc_html__( "Enter a text for the 'Coupon:' title in cart", 'yith-woocommerce-gift-cards' ),
	        'type'    => 'yith-field',
	        'yith-type' => 'text',
	        'id'      => 'ywgc_apply_coupon_title_text_button',
	        'custom_attributes' => 'placeholder="' . __( 'write the coupon field title', 'yith-woocommerce-gift-cards' ) . '"',
	        'default' => esc_html__( 'Coupon:', 'yith-woocommerce-gift-cards' ),
	        'deps' => array(
		        'id' => 'ywgc_apply_gift_card_on_coupon_form',
		        'value' => 'yes'
	        ),
        ),
        'ywgc_apply_coupon_placeholder_text_button'    => array(
	        'name'    => esc_html__( "Enter a text for the 'Coupon code' placeholder in cart", 'yith-woocommerce-gift-cards' ),
	        'type'    => 'yith-field',
	        'yith-type' => 'text',
	        'id'      => 'ywgc_apply_coupon_placeholder_text_button',
	        'custom_attributes' => 'placeholder="' . __( 'write the coupon field placeholder', 'yith-woocommerce-gift-cards' ) . '"',
	        'default' => esc_html__( 'Coupon code', 'yith-woocommerce-gift-cards' ),
	        'deps' => array(
		        'id' => 'ywgc_apply_gift_card_on_coupon_form',
		        'value' => 'yes'
	        ),
        ...
        'ywgc_apply_coupon_label_text'    => array(
            'name'    => esc_html__( "Enter a text for the 'Have a coupon?' label in checkout", 'yith-woocommerce-gift-cards' ),
            'type'    => 'yith-field',
            'yith-type' => 'text',
        ...
        'ywgc_apply_coupon_checkout_text'    => array(
	        'name'    => esc_html__( "Enter a text for the 'Have a coupon?' description in checkout", 'yith-woocommerce-gift-cards' ),
	        'type'    => 'yith-field',
	        'yith-type' => 'text',
	        'id'      => 'ywgc_apply_coupon_checkout_text',
	        'custom_attributes' => 'placeholder="' . __( 'write the apply coupon description text', 'yith-woocommerce-gift-cards' ) . '"',

	        'default' => esc_html__( 'If you have a coupon code, please apply it below.', 'yith-woocommerce-gift-cards' ),
	        'deps' => array(
		        'id' => 'ywgc_apply_gift_card_on_coupon_form',
		        'value' => 'yes'
	        ),
        ...
        'ywgc_gift_card_form_on_cart'    => array(
	        'name'    => esc_html__( 'Show gift card field on Cart', 'yith-woocommerce-gift-cards' ),
	        'type'    => 'yith-field',
	        'yith-type' => 'onoff',
	        'id'      => 'ywgc_gift_card_form_on_cart',
	        'desc'    => esc_html__( 'If enabled, customers can apply the gift card code in the default field on Cart.', 'yith-woocommerce-gift-cards' ),
	        'default' => 'yes',
        ),
        ...
        'ywgc_gift_card_form_on_checkout'    => array(
            'name'    => esc_html__( 'Show gift card field on Checkout', 'yith-woocommerce-gift-cards' ),
            'type'    => 'yith-field',
            'yith-type' => 'onoff',
            'id'      => 'ywgc_gift_card_form_on_checkout',
            'desc'    => esc_html__( 'If enabled, customers can apply the gift card code in the default field on Checkout.', 'yith-woocommerce-gift-cards' ),
            'default' => 'yes',
        ),
