...
$general_options = array(
	...
	'general' => array(
        ...
        'ywgc_enable_pre_printed_physical'     => array(
            'name'    => esc_html__( 'Disable code generation in physical gift cards', 'yith-woocommerce-gift-cards' ),
            'type'    => 'yith-field',
            'yith-type' => 'onoff',
            'id'      => 'ywgc_enable_pre_printed_physical',
            'desc'    => esc_html__( 'Enable this option if you want to create physical gift cards without any code.', 'yith-woocommerce-gift-cards' ),
            'default' => 'no',
        ),
        'ywgc_enable_pre_printed_virtual'     => array(
	        'name'    => esc_html__( 'Disable code generation in virtual gift cards', 'yith-woocommerce-gift-cards' ),
	        'type'    => 'yith-field',
	        'yith-type' => 'onoff',
	        'id'      => 'ywgc_enable_pre_printed_virtual',
	        'desc'    => esc_html__( 'Enable this option if you want to create virtual gift cards without any code.', 'yith-woocommerce-gift-cards' ),
	        'default' => 'no',
        ),
        ...
        'ywgc_apply_gc_code_on_gc_product'     => array(
            ...
            'desc'    => esc_html__( 'If enabled, the use of gift cards codes to purchase a gift card product is not allowed. This option is only valid when using the default gift card fields to redeem a code.', 'yith-woocommerce-gift-cards' ),
            'default' => 'no',
        ),
        ...
        'ywgc_permit_free_amount'     => array(
            'name'    => esc_html__( 'Allow custom amount', 'yith-woocommerce-gift-cards' ),
            'type'    => 'yith-field',
            'yith-type' => 'onoff',
