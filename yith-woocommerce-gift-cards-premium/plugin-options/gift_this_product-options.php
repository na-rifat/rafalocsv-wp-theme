...
$gift_this_product_options = array(
	...
	'gift_this_product' => array(
        ...
        'ywgc_gift_this_product_include_shipping'   => array(
	        'name'    => esc_html__( 'Include shipping cost in the "Gift this product" option', 'yith-woocommerce-gift-cards' ),
	        'type'    => 'yith-field',
	        'yith-type' => 'onoff',
	        'id'      => 'ywgc_gift_this_product_include_shipping',
	        'desc'    => esc_html__( 'Enable to allow users to also pay the shipping cost for the product that has been selected as a gift.', 'yith-woocommerce-gift-cards' ),
	        'default' => 'no',
	        'deps'      => array(
		        'id'    => 'ywgc_permit_its_a_present',
		        'value' => 'yes',
