                ...
                if ( $this->is_marketplace ) {
                    if ( wcfm_is_vendor() ) {
                        ...
                        if ( $this->is_marketplace == 'wcvendors' ) {
                            $this->wcfm_marketplace = new WCFM_WCVendors();
                        } elseif ( $this->is_marketplace == 'wcmarketplace' ) {
                            $this->wcfm_marketplace = new WCFM_WCMarketplace();
                        } elseif ( $this->is_marketplace == 'wcpvendors' ) {
                            $this->wcfm_marketplace = new WCFM_WCPVendors();
                        } elseif ( $this->is_marketplace == 'dokan' ) {
                            $this->wcfm_marketplace = new WCFM_Dokan();
                        } elseif ( $this->is_marketplace == 'wcfmmarketplace' ) {
                            $this->wcfm_marketplace = new WCFM_Marketplace();
                        }
        ...
        function wcfm_hide_admin_bar_prefs() {
			...
			<?php
                    ...
                    function get_wcfm_menus() {
                        global $WCFM;
                        $wcfm_menus = apply_filters( 'wcfm_menus', array( 'wcfm-products' => array(
                            'label'              => __( 'Productss', 'wc-frontend-manager' ),
                        ...
                        if ( ! function_exists( 'wc_coupons_enabled' ) || ( function_exists( 'wc_coupons_enabled' ) && ! wc_coupons_enabled() ) || ! apply_filters( 'wcfm_is_pref_coupon', true ) ) {
                                    ...
                                    if ( ! empty( $wcfm_managed_menu['custom'] ) && ( $wcfm_managed_menu['custom'] == 'no' ) ) {
                                        if ( ! empty( $wcfm_managed_menu['slug'] ) && ( $wcfm_menu_key == $wcfm_managed_menu['slug'] ) ) {
                                            if ( isset( $wcfm_managed_menu['enable'] ) ) {
                                                ...
                                                if (  ( $wcfm_menu_key == 'wcfm-vendors' ) && apply_filters( 'wcfm_is_allow_vendors_menu_label_update_by_sold_label', true ) ) {
                                                    $wcfm_menu['label'] = apply_filters( 'wcfm_sold_by_label', '', $wcfm_managed_menu['label'] ) . ' ' . __( 'Vendors', 'wc-frontend-manager' );
                                                }

                                                $wcfm_menu['icon']     = wcfm_replace_unsupported_icons( $wcfm_managed_menu['icon'] );
                                                $wcfm_menu['menu_for'] = 'both';
                                                $wcfm_menu['new_tab']  = 'no';
                                                if ( isset( $wcfm_managed_menu['menu_for'] ) ) {
                                                    $wcfm_menu['menu_for'] = $wcfm_managed_menu['menu_for'];
                                                }

                                                if ( isset( $wcfm_managed_menu['new_tab'] ) ) {
                                                    $wcfm_menu['new_tab'] = $wcfm_managed_menu['new_tab'];
                                                }
                    ...
                    function get_wcfm_modules() {
                        $wcfm_modules = array(
                            ...
                            'product_popup'  => array( 'label' => __( 'Popup Add Voucher', 'wc-frontend-manager' ) ),
