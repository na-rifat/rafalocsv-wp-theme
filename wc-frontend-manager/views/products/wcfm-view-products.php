...
<div class="collapse wcfm-collapse" id="wcfm_products_listing">
	...
	<div class="wcfm-page-headig">
		...
		<span class="wcfm-page-heading-text"><?php _e( 'Vouchers', 'wc-frontend-manager' ); ?></span>
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			if( $is_allow_products_export = apply_filters( 'wcfm_is_allow_products_export', true ) ) {
				?>
				<a class="add_new_wcfm_ele_dashboard text_tip" href="<?php echo get_wcfm_export_product_url(); ?>" data-screen="product" data-tip="<?php _e( 'Vouchers Export', 'wc-frontend-manager' ); ?>"><span class="wcfmfa fa-download"><span class="text hidden-text"><?php _e( 'Vouchers Export', 'wc-frontend-manager'); ?></span></span></a>
				<?php
			}
		...
		<div class="wcfm_products_filter_wrap wcfm_filters_wrap">
			...
			if( $wcfm_is_products_type_filter = apply_filters( 'wcfm_is_products_type_filter', true ) ) {
				...
				$output .= '<option value="">' . __( 'All voucher types', 'wc-frontend-manager' ) . '</option>';
