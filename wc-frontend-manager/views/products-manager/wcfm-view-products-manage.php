...
if( isset( $wp->query_vars['wcfm-products-manage'] ) && empty( $wp->query_vars['wcfm-products-manage'] ) ) {
	if( !apply_filters( 'wcfm_is_allow_add_products', true ) ) {
		wcfm_restriction_message_show( "Add voucher" );
		return;
	}
		...
		if( WCFM_Dependencies::wcfmvm_plugin_active_check() ) {
			...
			<div class="collapse wcfm-collapse">
				<div class="wcfm-page-headig">
					...
					<span class="wcfm-page-heading-text"><?php _e( 'Add voucher', 'wc-frontend-manager' ); ?></span>
...
$product_types = apply_filters( 'wcfm_product_types', array('simple' => __('Simple Voucher', 'wc-frontend-manager'), 'variable' => __('Variable Voucher', 'wc-frontend-manager'), 'grouped' => __('Grouped Voucher', 'wc-frontend-manager'), 'external' => __('External/Affiliate Voucher', 'wc-frontend-manager') ) );
...
if( count( $product_types ) == 0 ) {
	$product_types = array('simple' => __('Simple Voucher', 'wc-frontend-manager') );
  ...
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<h2><?php if( $product_id ) { _e('Edit Product', 'wc-frontend-manager' ); } else { _e('Add voucher', 'wc-frontend-manager' ); } ?></h2>
			...
			if( $has_new = apply_filters( 'wcfm_add_new_product_sub_menu', true ) ) {
				echo '<a id="add_new_product_dashboard" class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_edit_product_url().'" data-tip="' . __('Add New Voucher', 'wc-frontend-manager') . '"><span class="wcfmfa fa-cube"></span><span class="text">' . __( 'Add New', 'wc-frontend-manager') . '</span></a>';
			}
				    ...
				    <?php do_action( 'wcfm_product_manager_left_panel_before', $product_id ); ?>
						...
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_general', array(
																																																...
																																																"pro_title" => array( 'placeholder' => __('Voucher Title', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_product_title wcfm_full_ele simple variable external grouped booking', 'value' => $title),
