...
$wcfm_product_types = apply_filters( 'wcfm_product_types', array('simple' => __('Simple Voucher', 'wc-frontend-manager'), 'virtual' => __('Virtual Product', 'wc-frontend-manager'), 'variable' => __('Variable Voucher', 'wc-frontend-manager'), 'grouped' => __('Grouped Voucher', 'wc-frontend-manager'), 'external' => __('External/Affiliate Voucher', 'wc-frontend-manager') ) );
