				    ...
				    <?php do_action( 'wcfm_product_manager_left_panel_before', $product_id ); ?>
						...
						<?php
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_general', array(
																																																...
																																																"pro_title" => array( 'placeholder' => __('Voucher Title', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking', 'value' => $title),
