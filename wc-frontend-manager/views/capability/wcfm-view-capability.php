					...
					<div id="wcfm_settings_form_vendor_expander" class="wcfm-content">
						...
						<div class="vendor_capability">
							...
							<div class="vendor_product_capability">
								<div class="vendor_capability_heading"><h3><?php _e( 'Vouchers', 'wc-frontend-manager' ); ?></h3></div>
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_capability_settings_fields_vendor_products', array(
																																																													 ...
																																																													 "add_products" => array('label' => __('Add vouchers', 'wc-frontend-manager') , 'name' => 'wcfm_capability_options[add_products]','type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $add_products),
